...
int AppZoo::run() const {
    ...
    try {
        std::vector<Abstract_animal*> animals_;

        animals_.push_back(new Abstract_animal("nick1", Date(2018, 5, 14)));
        animals_.push_back(new Abstract_animal("nick2", Date(2018, 12, 31)));


        Abstract_animal n1("nick9", Date(2018, 5, 14));
